  ...
  return (
    <div>
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-6 pb-24 pt-8 text-center">
          <span className="animate-fade-in inline-flex items-center gap-2 rounded-full border border-white/25 bg-white/10 px-5 py-1.5 text-xs font-semibold uppercase tracking-widest text-white backdrop-blur-md">
            ...
            Aliados estratégicos para tu negocio
          </span>
        ...
        <div className="grid lg:grid-cols-2">
          <div className="relative h-72 lg:h-auto lg:min-h-[520px]">
            ...
            <div className="absolute bottom-6 left-6 rounded-2xl bg-white/90 px-5 py-3 backdrop-blur-sm shadow-lg">
              ...
              <p className="text-lg font-black text-neutral-900" style={{ fontFamily: "var(--font-display)" }}>20+ años</p>
            </div>
          </div>
          <div className="flex items-center bg-white px-8 py-14 lg:px-16">
            <div className="max-w-lg">
              <span className="text-xs font-bold uppercase tracking-widest text-brand-red">Quiénes somos</span>
      ...
      <section className="relative h-72 overflow-hidden sm:h-96">
        <Image src={IMGS.factory} alt="Planta de producción Consorcio Dely" fill className="object-cover object-center" sizes="100vw" />
        ...
        <div className="relative flex h-full items-center justify-center px-6 text-center text-white">
          <div>
            <p className="text-sm font-bold uppercase tracking-widest text-white/70" style={{ fontFamily: "var(--font-display)" }}>Producción peruana</p>
            <h2 className="mt-2 text-3xl font-black sm:text-5xl" style={{ fontFamily: "var(--font-display)", textShadow: "0 2px 16px rgba(0,0,0,0.4)" }}>Fabricado con orgullo en Perú</h2>
            <p className="mx-auto mt-4 max-w-xl text-sm text-white/80 sm:text-base">Nuestra planta de producción opera bajo estándares internacionales para garantizar la calidad que merece tu negocio.</p>
          </div>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-2">
          <div className="flex items-center bg-brand-dark px-8 py-14 lg:px-16">
            <div className="max-w-lg">
              ...
              <Link href="/contacto" className="btn-primary mt-8">Solicitar cotización</Link>
            </div>
          </div>
          <div className="relative h-72 lg:h-auto lg:min-h-[520px]">
        ...
        <div className="relative mx-auto max-w-6xl px-6">
          <div className="grid items-center gap-10 sm:grid-cols-2">
            <div className="text-white">
              ...
              <h2 className="text-3xl font-black sm:text-4xl">Encuéntranos cerca de ti</h2>
              <p className="mt-4 leading-relaxed text-white/80">{settings?.address ?? "Escríbenos para conocer nuestro punto de venta más cercano a ti."}</p>
      ...
      <section className="py-24">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-neutral-500">
            Únete a los más de 1,000 clientes que confían en Consorcio Dely para abastecer
            sus negocios con los mejores productos del mercado peruano.
          </p>
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            <Link href="/catalogo" className="btn-primary text-base">Explorar catálogo</Link>
