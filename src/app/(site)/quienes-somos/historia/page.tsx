    ...
    <div>
      <div className="relative h-64 overflow-hidden sm:h-80" style={{ background: "linear-gradient(135deg,#1a0000,#b01a14)" }}>
        ...
        <div className="relative flex h-full flex-col items-center justify-center px-6 text-center text-white">
          ...
          <p className="mt-2 text-sm text-white/70">Más de 20 años creciendo junto al Perú</p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-5xl px-6 py-16">
        <div className="grid gap-16 lg:grid-cols-2 lg:items-start">
          <div>
            ...
            <h2 className="section-title mt-2 text-2xl font-black text-neutral-900 sm:text-3xl">De Lima al Perú entero</h2>
            <p className="mt-5 whitespace-pre-line leading-relaxed text-neutral-600">{texto}</p>
            <p className="mt-4 leading-relaxed text-neutral-600">Complementamos nuestro catálogo con marcas aliadas como P&G, Alicorp, Nestlé, Gloria y Molitalia. Trabajamos con mayoristas, bodegueros y minoristas bajo un mismo principio: crecemos junto a cada cliente que confía en nosotros.</p>
          </div>
