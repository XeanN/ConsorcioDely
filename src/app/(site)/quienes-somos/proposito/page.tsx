...
export default async function PropositoPage() {
  ...
  const texto = rows[0]?.value ?? "Creemos que el crecimiento de cada bodeguero, mayorista y minorista del Perú es también nuestro crecimiento.";
    ...
    <div>
      <div className="relative h-64 overflow-hidden sm:h-80" style={{ background: "var(--brand-dark)" }}>
        ...
        <div className="relative flex h-full flex-col items-center justify-center px-6 text-center text-white">
          ...
          <h1 className="mt-2 text-4xl font-black uppercase sm:text-5xl" style={{ fontFamily: "var(--font-display)" }}>Nuestro Propósito</h1>
          <p className="mt-2 text-sm text-white/60">Por qué hacemos lo que hacemos</p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-5xl px-6 py-16">
        <div className="grid gap-12 lg:grid-cols-3">
          <div className="lg:col-span-2">
            <span className="text-xs font-bold uppercase tracking-widest text-brand-red">Misión</span>
        ...
        <div className="mt-12 overflow-hidden rounded-2xl">
          <div className="relative h-48">
            <Image src="https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=1200&q=80" alt="Propósito Dely" fill className="object-cover" sizes="100vw" />
            ...
            <div className="relative flex h-full items-center px-8">
              <div className="text-white">
                <p className="text-lg font-black" style={{ fontFamily: "var(--font-display)" }}>Visión 2030</p>
                <p className="mt-1 max-w-lg text-sm text-white/80">Ser la empresa de abarrotes más confiable y accesible del Perú, presente en cada hogar y negocio del país.</p>
              </div>
            </div>
          </div>
        </div>
