      ...
      {filtered.length === 0 ? (
        ...
        <div>
          <div className="mb-4 flex items-center justify-between border-b border-neutral-100 pb-2">
            ...
            <button onClick={() => setSearch("")} className="text-xs text-brand-red hover:underline">
              Limpiar filtro
            </button>
          </div>
              ...
              <div key={c.id}>
                <div className="mb-5 flex items-center justify-between border-b border-neutral-100 pb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="rounded-full bg-brand-red-ultra px-2.5 py-0.5 text-xs font-bold text-brand-red">
                      {grouped![c.id].length} productos
                    </span>
                  </div>
                  <Link
